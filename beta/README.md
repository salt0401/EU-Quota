...
- **Status:** Phase 2 is DEFERRED. It becomes technically possible at 30 days (~2026-08-04); starting it is an owner decision, not a date - see `docs/TODO.md` section 4
